...
class HttpServer {
    ...
    handleModules(module, container, containerModulesObjects = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!container.isBound(module.name)) {
                return yield this.loadModule(module, container, modules, containerModulesObjects);
            }
            else {
    ...
    loadModule(module, container, modules, containerModulesObjects) {
        ...
        if (res instanceof Promise) {
            ...
            res = Promise.all(modules.map((subModule) => __awaiter(this, void 0, void 0, function* () { return this.handleModules(subModule, container, containerModulesObjects); })));
        }
