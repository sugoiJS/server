...
class HttpServer {
    ...
    handleModules(module, container, graph = [], containerModulesObjects = {
        asyncContainers: [],
        containers: []
    }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (graph.length === 0) {
                injector_class_1.Injector.setContainer(this.container);
                services.unshift(injector_class_1.Injector);
            }
            ...
            if (!container.isBound(module.name)) {
                return yield this.loadModule(module, container, modules, graph, containerModulesObjects);
            }
            else {
    ...
    loadModule(module, container, modules, graph, containerModulesObjects) {
        ...
        if (res instanceof Promise) {
            ...
            res = Promise.all(modules.map((subModule) => __awaiter(this, void 0, void 0, function* () { return this.handleModules(subModule, container, graph, containerModulesObjects); })));
        }
        if (res) {
            this._asyncModules.set(moduleInstance.constructor.name, res);
            this._asyncModulesList.push(res);
        }
        return res;
    }
    ...
    static updateGraph(graph, moduleName) {
