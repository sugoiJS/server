...
var ParametersValidatorUtil = /** @class */ (function () {
    ...
    ParametersValidatorUtil.validateRequest = function (args) {
        ...
        var request = ParametersValidatorUtil.getRequestFromArgs(args);
    ...
    ParametersValidatorUtil.getRequestFromArgs = function (args) {
        return args.functionArgs.find(function (arg) { return arg && arg.constructor && arg.constructor.name === 'IncomingMessage'; });
    };
    __decorate([
        core_1.Policy(),
